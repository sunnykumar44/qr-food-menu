...
const dictionary = {
  en: {
    ...
    allShops: "All Shops",
    allShopsDeleted: "All shops deleted.",
    confirmDeleteAllShops: "Are you sure you want to delete ALL shops?",
  ...
  te: {
    ...
    telugu: "తెలుగు",
    yourShops: "మీ షాపులు",
    createShop: "కొత్త QR సృష్టించండి",
    ...
    allShopsDeleted: "అన్ని షాపులు తొలగించబడ్డాయి.",
    confirmDeleteAllShops: "మీరు ఖచ్చితంగా అన్ని షాపులను తొలగించాలనుకుంటున్నారా?",
